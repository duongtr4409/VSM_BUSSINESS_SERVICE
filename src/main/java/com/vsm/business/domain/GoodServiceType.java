 ...
 */
@Entity
@Table(name = "good_service_type")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "goodservicetype")
public class GoodServiceType implements Serializable {
    ...
    @Column(name = "good_service_type_name")
    private String goodServiceTypeName;

    @Column(name = "good_service_type_code")
    ...
    @OneToMany(mappedBy = "goodServiceType")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public GoodServiceType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public String getGoodServiceTypeName() {
        return this.goodServiceTypeName;
    }

    public GoodServiceType goodServiceTypeName(String goodServiceTypeName) {
        this.setGoodServiceTypeName(goodServiceTypeName);
        return this;
    }
    ...
    public String getGoodServiceTypeCode() {
        return this.goodServiceTypeCode;
    }

    public GoodServiceType goodServiceTypeCode(String goodServiceTypeCode) {
        this.setGoodServiceTypeCode(goodServiceTypeCode);
        return this;
    }
    ...
    public GoodServiceType description(String description) {
    ...
    public GoodServiceType createdName(String createdName) {
    ...
    public GoodServiceType createdOrgName(String createdOrgName) {
    ...
    public GoodServiceType createdRankName(String createdRankName) {
    ...
    public GoodServiceType createdDate(Instant createdDate) {
    ...
    public GoodServiceType modifiedName(String modifiedName) {
    ...
    public GoodServiceType modifiedDate(Instant modifiedDate) {
    ...
    public GoodServiceType isActive(Boolean isActive) {
    ...
    public GoodServiceType isDelete(Boolean isDelete) {
    ...
    public GoodServiceType creater(UserInfo userInfo) {
    ...
    public GoodServiceType modifier(UserInfo userInfo) {
    ...
    public void setGoodServices(Set<GoodService> goodServices) {
        if (this.goodServices != null) {
            this.goodServices.forEach(i -> i.setGoodServiceType(null));
        }
        if (goodServices != null) {
            goodServices.forEach(i -> i.setGoodServiceType(this));
        }
        this.goodServices = goodServices;
    }

    public GoodServiceType goodServices(Set<GoodService> goodServices) {
        this.setGoodServices(goodServices);
        return this;
    }

    public GoodServiceType addGoodService(GoodService goodService) {
        this.goodServices.add(goodService);
        goodService.setGoodServiceType(this);
        return this;
    }

    public GoodServiceType removeGoodService(GoodService goodService) {
        this.goodServices.remove(goodService);
        goodService.setGoodServiceType(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoodServiceType)) {
            return false;
        }
        return id != null && id.equals(((GoodServiceType) o).id);
    }
