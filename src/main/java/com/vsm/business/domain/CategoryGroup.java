...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "categorygroup")
public class CategoryGroup implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "tennant", "created", "modified", "parent", "categoryData", "children" }, allowSetters = true)
    private Set<CategoryGroup> children = new HashSet<>();
    ...
    public CategoryGroup id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public CategoryGroup code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public CategoryGroup description(String description) {
    ...
    public CategoryGroup createdName(String createdName) {
    ...
    public CategoryGroup createdOrgName(String createdOrgName) {
    ...
    public CategoryGroup createdRankName(String createdRankName) {
    ...
    public CategoryGroup createdDate(Instant createdDate) {
    ...
    public CategoryGroup modifiedName(String modifiedName) {
    ...
    public CategoryGroup modifiedDate(Instant modifiedDate) {
    ...
    public CategoryGroup isActive(Boolean isActive) {
    ...
    public CategoryGroup isDelete(Boolean isDelete) {
    ...
    public CategoryGroup tennantCode(String tennantCode) {
    ...
    public CategoryGroup tennantName(String tennantName) {
    ...
    public CategoryGroup tennant(Tennant tennant) {
    ...
    public CategoryGroup created(UserInfo userInfo) {
    ...
    public CategoryGroup modified(UserInfo userInfo) {
    ...
    public CategoryGroup parent(CategoryGroup categoryGroup) {
        this.setParent(categoryGroup);
        return this;
    }
    ...
    public void setCategoryData(Set<CategoryData> categoryData) {
        if (this.categoryData != null) {
            this.categoryData.forEach(i -> i.setCategoryGroup(null));
        }
        if (categoryData != null) {
            categoryData.forEach(i -> i.setCategoryGroup(this));
        }
        this.categoryData = categoryData;
    }

    public CategoryGroup categoryData(Set<CategoryData> categoryData) {
        this.setCategoryData(categoryData);
        return this;
    }

    public CategoryGroup addCategoryData(CategoryData categoryData) {
        this.categoryData.add(categoryData);
        categoryData.setCategoryGroup(this);
        return this;
    }

    public CategoryGroup removeCategoryData(CategoryData categoryData) {
        this.categoryData.remove(categoryData);
        categoryData.setCategoryGroup(null);
        return this;
    }

    public Set<CategoryGroup> getChildren() {
        return this.children;
    }

    public void setChildren(Set<CategoryGroup> categoryGroups) {
        if (this.children != null) {
            this.children.forEach(i -> i.setParent(null));
        }
        if (categoryGroups != null) {
            categoryGroups.forEach(i -> i.setParent(this));
        }
        this.children = categoryGroups;
    }

    public CategoryGroup children(Set<CategoryGroup> categoryGroups) {
        this.setChildren(categoryGroups);
        return this;
    }

    public CategoryGroup addChildren(CategoryGroup categoryGroup) {
        this.children.add(categoryGroup);
        categoryGroup.setParent(this);
        return this;
    }

    public CategoryGroup removeChildren(CategoryGroup categoryGroup) {
        this.children.remove(categoryGroup);
        categoryGroup.setParent(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((CategoryGroup) o).id);
    }
