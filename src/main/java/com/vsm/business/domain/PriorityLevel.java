...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "prioritylevel")
public class PriorityLevel implements Serializable {
    ...
    public PriorityLevel id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public PriorityLevel priorityCode(String priorityCode) {
    ...
    public PriorityLevel priorityName(String priorityName) {
    ...
    public PriorityLevel priorityValue(Long priorityValue) {
    ...
    public PriorityLevel description(String description) {
    ...
    public PriorityLevel createdName(String createdName) {
    ...
    public PriorityLevel createdOrgName(String createdOrgName) {
    ...
    public PriorityLevel createdRankName(String createdRankName) {
    ...
    public PriorityLevel createdDate(Instant createdDate) {
    ...
    public PriorityLevel modifiedName(String modifiedName) {
    ...
    public PriorityLevel modifiedDate(Instant modifiedDate) {
    ...
    public PriorityLevel isActive(Boolean isActive) {
    ...
    public PriorityLevel isDelete(Boolean isDelete) {
    ...
    public PriorityLevel creater(UserInfo userInfo) {
    ...
    public PriorityLevel modifier(UserInfo userInfo) {
    ...
    public void setOfficialDispatches(Set<OfficialDispatch> officialDispatches) {
        if (this.officialDispatches != null) {
            this.officialDispatches.forEach(i -> i.setPriorityLevel(null));
        }
        if (officialDispatches != null) {
            officialDispatches.forEach(i -> i.setPriorityLevel(this));
        }
        this.officialDispatches = officialDispatches;
    }

    public PriorityLevel officialDispatches(Set<OfficialDispatch> officialDispatches) {
        this.setOfficialDispatches(officialDispatches);
        return this;
    }

    public PriorityLevel addOfficialDispatch(OfficialDispatch officialDispatch) {
        this.officialDispatches.add(officialDispatch);
        officialDispatch.setPriorityLevel(this);
        return this;
    }

    public PriorityLevel removeOfficialDispatch(OfficialDispatch officialDispatch) {
        this.officialDispatches.remove(officialDispatch);
        officialDispatch.setPriorityLevel(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriorityLevel)) {
            return false;
        }
        return id != null && id.equals(((PriorityLevel) o).id);
    }
