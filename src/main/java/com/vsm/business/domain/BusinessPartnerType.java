...
/**
 * A BusinessPartnerType.
 */
@Entity
@Table(name = "business_partner_type")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "businesspartnertype")
public class BusinessPartnerType implements Serializable {
    ...
    @OneToMany(mappedBy = "businessPartnerType")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "businessPartnerType", "creater", "modifier" }, allowSetters = true)
    ...
    public BusinessPartnerType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public String getBpTypeName() {
        return this.bpTypeName;
    }

    public BusinessPartnerType bpTypeName(String bpTypeName) {
        this.setBpTypeName(bpTypeName);
        return this;
    }
    ...
    public BusinessPartnerType bpTypeCode(String bpTypeCode) {
        this.setBpTypeCode(bpTypeCode);
        return this;
    }
    ...
    public BusinessPartnerType description(String description) {
    ...
    public BusinessPartnerType createdName(String createdName) {
    ...
    public BusinessPartnerType createdOrgName(String createdOrgName) {
    ...
    public BusinessPartnerType createdRankName(String createdRankName) {
    ...
    public BusinessPartnerType createdDate(Instant createdDate) {
    ...
    public BusinessPartnerType modifiedName(String modifiedName) {
    ...
    public BusinessPartnerType modifiedDate(Instant modifiedDate) {
    ...
    public BusinessPartnerType isActive(Boolean isActive) {
    ...
    public BusinessPartnerType isDelete(Boolean isDelete) {
    ...
    public BusinessPartnerType creater(UserInfo userInfo) {
    ...
    public BusinessPartnerType modifier(UserInfo userInfo) {
    ...
    public void setBusinessPartners(Set<BusinessPartner> businessPartners) {
        if (this.businessPartners != null) {
            this.businessPartners.forEach(i -> i.setBusinessPartnerType(null));
        }
        if (businessPartners != null) {
            businessPartners.forEach(i -> i.setBusinessPartnerType(this));
        }
        this.businessPartners = businessPartners;
    }

    public BusinessPartnerType businessPartners(Set<BusinessPartner> businessPartners) {
        this.setBusinessPartners(businessPartners);
        return this;
    }

    public BusinessPartnerType addBusinessPartner(BusinessPartner businessPartner) {
        this.businessPartners.add(businessPartner);
        businessPartner.setBusinessPartnerType(this);
        return this;
    }

    public BusinessPartnerType removeBusinessPartner(BusinessPartner businessPartner) {
        this.businessPartners.remove(businessPartner);
        businessPartner.setBusinessPartnerType(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BusinessPartnerType)) {
            return false;
        }
        return id != null && id.equals(((BusinessPartnerType) o).id);
    }
