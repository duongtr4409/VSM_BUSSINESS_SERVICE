...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "rolerequest")
public class RoleRequest implements Serializable {
    ...
    public RoleRequest isView(Boolean isView) {
    ...
    public RoleRequest isEdit(Boolean isEdit) {
    ...
    public RoleRequest isDelete(Boolean isDelete) {
    ...
    public RoleRequest isDownload(Boolean isDownload) {
    ...
    public RoleRequest description(String description) {
    ...
    public RoleRequest createdName(String createdName) {
    ...
    public RoleRequest createdOrgName(String createdOrgName) {
    ...
    public RoleRequest createdRankName(String createdRankName) {
    ...
    public RoleRequest createdDate(Instant createdDate) {
    ...
    public RoleRequest modifiedName(String modifiedName) {
    ...
    public RoleRequest modifiedDate(Instant modifiedDate) {
    ...
    public RoleRequest isActive(Boolean isActive) {
    ...
    public RoleRequest created(UserInfo userInfo) {
    ...
    public RoleRequest modified(UserInfo userInfo) {
    ...
    public RoleRequest role(Role role) {
        this.setRole(role);
        return this;
    }
    ...
    public RoleRequest request(Request request) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((RoleRequest) o).id);
    }
