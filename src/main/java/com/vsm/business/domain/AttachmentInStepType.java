...
/**
 * A AttachmentInStepType.
 */
@Entity
@Table(name = "attachment_in_step_type")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "attachmentinsteptype")
public class AttachmentInStepType implements Serializable {
    ...
    @OneToMany(mappedBy = "attachmentInStepType")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public AttachmentInStepType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public AttachmentInStepType typeCode(String typeCode) {
    ...
    public AttachmentInStepType typeName(String typeName) {
    ...
    public AttachmentInStepType createdName(String createdName) {
    ...
    public AttachmentInStepType createdOrgName(String createdOrgName) {
    ...
    public AttachmentInStepType createdRankName(String createdRankName) {
    ...
    public AttachmentInStepType createdDate(Instant createdDate) {
    ...
    public AttachmentInStepType modifiedName(String modifiedName) {
    ...
    public AttachmentInStepType modifiedate(Instant modifiedate) {
    ...
    public AttachmentInStepType isActive(Boolean isActive) {
    ...
    public AttachmentInStepType isDelete(Boolean isDelete) {
    ...
    public AttachmentInStepType creater(UserInfo userInfo) {
    ...
    public AttachmentInStepType modifier(UserInfo userInfo) {
    ...
    public void setAttachmentInSteps(Set<AttachmentInStep> attachmentInSteps) {
        if (this.attachmentInSteps != null) {
            this.attachmentInSteps.forEach(i -> i.setAttachmentInStepType(null));
        }
        if (attachmentInSteps != null) {
            attachmentInSteps.forEach(i -> i.setAttachmentInStepType(this));
        }
        this.attachmentInSteps = attachmentInSteps;
    }

    public AttachmentInStepType attachmentInSteps(Set<AttachmentInStep> attachmentInSteps) {
        this.setAttachmentInSteps(attachmentInSteps);
        return this;
    }

    public AttachmentInStepType addAttachmentInStep(AttachmentInStep attachmentInStep) {
        this.attachmentInSteps.add(attachmentInStep);
        attachmentInStep.setAttachmentInStepType(this);
        return this;
    }

    public AttachmentInStepType removeAttachmentInStep(AttachmentInStep attachmentInStep) {
        this.attachmentInSteps.remove(attachmentInStep);
        attachmentInStep.setAttachmentInStepType(null);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachmentInStepType)) {
            return false;
        }
        return id != null && id.equals(((AttachmentInStepType) o).id);
    }
