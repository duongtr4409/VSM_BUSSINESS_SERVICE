...
public class Status implements Serializable {
    ...
    private Set<RequestData> statusRequests = new HashSet<>();
    ...
    private Set<RequestData> subStatusRequests = new HashSet<>();
    ...
    public Status statusType(String statusType) {
    ...
    public Status createdName(String createdName) {
    ...
    public Status createdOrgName(String createdOrgName) {
    ...
    public Status createdRankName(String createdRankName) {
    ...
    public Status modifiedName(String modifiedName) {
    ...
    public Status modifiedDate(Instant modifiedDate) {
    ...
    public Status isActive(Boolean isActive) {
    ...
    public Status isDelete(Boolean isDelete) {
    ...
    public Status tennantCode(String tennantCode) {
    ...
    public Status tennantName(String tennantName) {
    ...
    public Status tennant(Tennant tennant) {
    ...
    public Status created(UserInfo userInfo) {
    ...
    public Status modified(UserInfo userInfo) {
        this.setModified(userInfo);
        return this;
    }

    public Set<RequestData> getStatusRequests() {
        return this.statusRequests;
    }

    public void setStatusRequests(Set<RequestData> requestData) {
        if (this.statusRequests != null) {
            this.statusRequests.forEach(i -> i.setStatus(null));
        }
        if (requestData != null) {
            requestData.forEach(i -> i.setStatus(this));
        }
        this.statusRequests = requestData;
    }

    public Status statusRequests(Set<RequestData> requestData) {
        this.setStatusRequests(requestData);
        return this;
    }

    public Status addStatusRequests(RequestData requestData) {
        this.statusRequests.add(requestData);
        requestData.setStatus(this);
        return this;
    }

    public Status removeStatusRequests(RequestData requestData) {
        this.statusRequests.remove(requestData);
        requestData.setStatus(null);
        return this;
    }

    public Set<RequestData> getSubStatusRequests() {
        return this.subStatusRequests;
    }

    public void setSubStatusRequests(Set<RequestData> requestData) {
        if (this.subStatusRequests != null) {
            this.subStatusRequests.forEach(i -> i.setSubStatus(null));
        }
        if (requestData != null) {
            requestData.forEach(i -> i.setSubStatus(this));
        }
        this.subStatusRequests = requestData;
    }

    public Status subStatusRequests(Set<RequestData> requestData) {
        this.setSubStatusRequests(requestData);
        return this;
    }

    public Status addSubStatusRequests(RequestData requestData) {
        this.subStatusRequests.add(requestData);
        requestData.setSubStatus(this);
        return this;
    }

    public Status removeSubStatusRequests(RequestData requestData) {
        this.subStatusRequests.remove(requestData);
        requestData.setSubStatus(null);
        return this;
    }
