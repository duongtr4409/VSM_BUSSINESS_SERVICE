 ...
 */
@Entity
@Table(name = "dispatch_book_type")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "dispatchbooktype")
public class DispatchBookType implements Serializable {
    ...
    public DispatchBookType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public DispatchBookType dispatchBookTypeName(String dispatchBookTypeName) {
    ...
    public DispatchBookType dispatchBookTypeCode(String dispatchBookTypeCode) {
    ...
    public DispatchBookType description(String description) {
    ...
    public DispatchBookType createdName(String createdName) {
    ...
    public DispatchBookType createdOrgName(String createdOrgName) {
    ...
    public DispatchBookType createdRankName(String createdRankName) {
    ...
    public DispatchBookType createdDate(Instant createdDate) {
    ...
    public DispatchBookType modifiedName(String modifiedName) {
    ...
    public DispatchBookType modifiedDDate(Instant modifiedDDate) {
    ...
    public DispatchBookType isActive(Boolean isActive) {
    ...
    public DispatchBookType isDelete(Boolean isDelete) {
    ...
    public DispatchBookType creater(UserInfo userInfo) {
    ...
    public DispatchBookType modifier(UserInfo userInfo) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DispatchBookType)) {
            return false;
        }
        return id != null && id.equals(((DispatchBookType) o).id);
    }
