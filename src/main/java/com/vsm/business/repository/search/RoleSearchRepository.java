 ...
 */
public interface RoleSearchRepository extends ElasticsearchRepository<Role, Long>, RoleSearchRepositoryInternal {}
...
class RoleSearchRepositoryInternalImpl implements RoleSearchRepositoryInternal {
    ...
    RoleSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<Role> search(String query, Pageable pageable) {
        ...
        List<Role> hits = elasticsearchTemplate
            .search(nativeSearchQuery, Role.class)
