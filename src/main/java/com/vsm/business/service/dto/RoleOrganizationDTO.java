...
/**
 * A DTO for the {@link com.vsm.business.domain.RoleOrganization} entity.
 */
public class RoleOrganizationDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RoleOrganizationDTO)) {
            return false;
        }

        RoleOrganizationDTO roleOrganizationDTO = (RoleOrganizationDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, roleOrganizationDTO.id);
    }
