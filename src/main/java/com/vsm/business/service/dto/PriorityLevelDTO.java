...
/**
 * A DTO for the {@link com.vsm.business.domain.PriorityLevel} entity.
 */
public class PriorityLevelDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriorityLevelDTO)) {
            return false;
        }

        PriorityLevelDTO priorityLevelDTO = (PriorityLevelDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, priorityLevelDTO.id);
    }
