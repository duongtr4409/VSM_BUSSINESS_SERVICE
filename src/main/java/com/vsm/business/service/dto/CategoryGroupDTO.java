...
/**
 * A DTO for the {@link com.vsm.business.domain.CategoryGroup} entity.
 */
public class CategoryGroupDTO implements Serializable {
    ...
    private CategoryGroupDTO parent;
    ...
    public CategoryGroupDTO getParent() {
        return parent;
    }

    public void setParent(CategoryGroupDTO parent) {
        this.parent = parent;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CategoryGroupDTO)) {
            return false;
        }
