...
/**
 * A DTO for the {@link com.vsm.business.domain.SecurityLevel} entity.
 */
public class SecurityLevelDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecurityLevelDTO)) {
            return false;
        }

        SecurityLevelDTO securityLevelDTO = (SecurityLevelDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, securityLevelDTO.id);
    }
