...
/**
 * A DTO for the {@link com.vsm.business.domain.DelegateDocument} entity.
 */
public class DelegateDocumentDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DelegateDocumentDTO)) {
            return false;
        }

        DelegateDocumentDTO delegateDocumentDTO = (DelegateDocumentDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, delegateDocumentDTO.id);
    }
