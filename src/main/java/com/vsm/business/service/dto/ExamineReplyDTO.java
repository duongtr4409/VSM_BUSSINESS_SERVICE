...
/**
 * A DTO for the {@link com.vsm.business.domain.ExamineReply} entity.
 */
public class ExamineReplyDTO implements Serializable {
    ...
    public ExamineDTO getExamine() {
        return examine;
    }

    public void setExamine(ExamineDTO examine) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExamineReplyDTO)) {
            return false;
        }

        ExamineReplyDTO examineReplyDTO = (ExamineReplyDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, examineReplyDTO.id);
    }
