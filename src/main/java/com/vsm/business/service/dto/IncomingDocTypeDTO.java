...
/**
 * A DTO for the {@link com.vsm.business.domain.IncomingDocType} entity.
 */
public class IncomingDocTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IncomingDocTypeDTO)) {
            return false;
        }

        IncomingDocTypeDTO incomingDocTypeDTO = (IncomingDocTypeDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, incomingDocTypeDTO.id);
    }
