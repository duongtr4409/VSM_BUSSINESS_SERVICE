...
/**
 * A DTO for the {@link com.vsm.business.domain.Examine} entity.
 */
public class ExamineDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ExamineDTO)) {
            return false;
        }

        ExamineDTO examineDTO = (ExamineDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, examineDTO.id);
    }
