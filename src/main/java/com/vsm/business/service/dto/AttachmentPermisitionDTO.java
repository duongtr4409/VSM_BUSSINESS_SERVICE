...
/**
 * A DTO for the {@link com.vsm.business.domain.AttachmentPermisition} entity.
 */
public class AttachmentPermisitionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttachmentPermisitionDTO)) {
            return false;
        }

        AttachmentPermisitionDTO attachmentPermisitionDTO = (AttachmentPermisitionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, attachmentPermisitionDTO.id);
    }
    ...
    public String toString() {
        return "AttachmentPermisitionDTO{" +
            "id=" + getId() +
            ", isView='" + getIsView() + "'" +
            ", isEdit='" + getIsEdit() + "'" +
