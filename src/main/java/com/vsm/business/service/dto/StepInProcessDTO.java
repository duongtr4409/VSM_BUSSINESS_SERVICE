...
/**
 * A DTO for the {@link com.vsm.business.domain.StepInProcess} entity.
 */
public class StepInProcessDTO implements Serializable {
	...
	private List<UserInStepDTO> userInStepDTOs = new ArrayList<>();
	...
	public List<UserInStepDTO> getUserInStepDTOs() {
        return userInStepDTOs;
    }

    public void setUserInStepDTOs(List<UserInStepDTO> userInStepDTOs) {
        this.userInStepDTOs = userInStepDTOs;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StepInProcessDTO)) {
            return false;
        }

        StepInProcessDTO stepInProcessDTO = (StepInProcessDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, stepInProcessDTO.id);
    }
