...
public class FormResource {
    ...
    private static final String ENTITY_NAME = "vsmBusinessServiceForm";
    ...
    public ResponseEntity<FormDTO> partialUpdateForm(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, formDTO.getId().toString())
        );
    }
    ...
    /**
     * {@code SEARCH  /_search/forms?query=:query} : search for the form corresponding
     * to the query.
     *
    ...
    public ResponseEntity<List<FormDTO>> searchForms(@RequestParam String query, Pageable pageable) {
