...
/**
 * REST controller for managing {@link com.vsm.business.domain.Vendor}.
 */
//@RestController
@RequestMapping("/api")
public class VendorResource {
    ...
    private static final String ENTITY_NAME = "vsmBusinessServiceVendor";
    ...
    public ResponseEntity<VendorDTO> updateVendor(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, vendorDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<VendorDTO> partialUpdateVendor(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, vendorDTO.getId().toString())
        );
    }
